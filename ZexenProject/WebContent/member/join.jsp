...
<!-- <link rel="stylesheet" href="../assets/scss/theme/_register.scss"> -->
...
<body>
  ...
  <div class="row row1">
    ...
    <table class="table">
     <tr>
       <th class="text-right danger" width="25%">아이디</th>
       <td width=85%>
         <input type=text name=member_id class="input-sm" size=15 readonly id="member_id">
